...
import { ConfigService } from './config.service';
 ...
 export class FightService {
   ...
   constructor(protected httpClient: HttpClient, private configService: ConfigService, @Optional() @Inject(BASE_PATH) basePath: string, @Optional() configuration: Configuration) {
   ...
   /**
    * Returns all the fight from the database
    *

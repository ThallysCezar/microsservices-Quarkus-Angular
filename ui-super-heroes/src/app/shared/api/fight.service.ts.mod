...
export class FightService {
  ...
  constructor(protected httpClient: HttpClient, @Optional() @Inject(BASE_PATH) basePath: string, @Optional() configuration: Configuration) {
    console.log(`1) basePath=${this.basePath}`);
    //let basePath = await this.getBasePath(window.location.protocol + "//" + window.location.host + "/api/frontend/basePath");
    //basePath = await this.httpClient.get<string>(window.location.protocol + "//" + window.location.host + "/api/frontend/basePath").toPromise();
    this.getBasePath(window.location.protocol + "//" + window.location.host + "/api/frontend/basePath");
    console.log(`2) basePath=${this.basePath}`);
    ...
    console.log(`3) basePath=${this.basePath}`);
  }
  ...
  private canConsumeForm(consumes: string[]): boolean {
   ...
   private async getBasePath(url: string) {
     console.log(`getBasePath this.basePath=${this.basePath}`);
     this.basePath = await this.httpClient.get<string>(url).toPromise();
     console.log(`getBasePath this.basePath=${this.basePath}`);
   }

   //async getBeasePath(url: string): string => {
  ...
  public apiFightsGet(observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.get<Array<Fight>>(`${this.basePath}/api/fight`,
      {
  ...
  public apiFightsHelloGet(observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.get<ModelString>(`${this.basePath}/api/fight/hello`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public apiFightsIdGet(id: ModelLong, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.get<Fight>(`${this.basePath}/api/fight/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public apiFightsPost(body: Fighters, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.post<URI>(`${this.basePath}/api/fight`,
      body,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiFightsRandomfightersGet(observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.get<Fighters>(`${this.basePath}/api/fight/randomfighters`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
